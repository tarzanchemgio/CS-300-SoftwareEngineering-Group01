...
export function TransactionsView({ navigation }: any) {
	return (
		<View style={[ styles.container]}>
			<View style = {[styles.container,{flex: 21, justifyContent: "flex-start", borderColor: 'blue', borderWidth: 5, width : '100%'}]}>
				<View   //total cash
					style={[ 
						{
							height: "12%",
				...
				> 
					<View style = {{justifyContent: "center", flexDirection :"row",}}>
						<View style = {{backgroundColor : "orange", width : 25, height: 25, borderRadius : 100, }}
						//--------------icon of total cash-----
						> 
				...
				>
					...
					<View style = {{flexDirection: "row", height: "25%",}}>
						...
						<View style = {{marginLeft : "auto", borderBottomColor : "#cccbca", borderBottomWidth: 1, marginBottom: 5, paddingRight : 3}}>
							<Text>                               value</Text>
						</View>
			...
			<View style = {{flex : 1}}>
				<View style ={{ //add transaction button
