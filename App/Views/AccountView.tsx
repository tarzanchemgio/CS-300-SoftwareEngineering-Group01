...
const ChangeInformationView = ({ navigation, route }: any) => {
	return (
		<View style={styles.container}>
			<Text style={[accountStyle.textCenter, { fontSize: 20 }]}>
				CHANGE INFORMATION
			</Text>
		</View>
	);
...
const AccountMainView = ({ navigation, route }: any) => {
	...
	return (
		<View style={[styles.container]}>
			<View
				style={{ flex: 0.3, width: "100%", backgroundColor: "#0459C5" }}
			></View>
			...
			<View style={accountStyle.form}>
				<View style={accountStyle.imageAvatarWrapper}>
					<Image
						...
						style={accountStyle.imageAvatar}
						resizeMode="center"
					/>
				</View>
				...
				<View style={accountStyle.inforWrapper}>
					<Text style={[accountStyle.inforName, accountStyle.textCenter]}>
						{user.fullname}
					</Text>
				...
				>
					<View style={[accountStyle.button, { backgroundColor: "#F2B824" }]}>
				...
				<TouchableNativeFeedback
					onPress={() => {
						navigation.navigate("OuterView");
					}}
				>
					<View style={[accountStyle.button, { backgroundColor: "#0459C5" }]}>
			...
			<View
				style={{ flex: 0.7, width: "100%", backgroundColor: "#FFFFFF" }}
			></View>
		</View>
	);
};
